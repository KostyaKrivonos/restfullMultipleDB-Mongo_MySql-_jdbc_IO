...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", basePackages = {
		"com.example.MongoAndMySqlMultiple.mysql.mysqlRepository.nameRepository" })
public class NameDbConfig {
	...
	public static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.example.MongoAndMySqlMultiple.mysql.modelMySql.name" };
	...
	public static final String DB_DRIVER = "spring.datasource.driver";
	public static final String DB_DIALECT = "spring.datasource.dialect";
